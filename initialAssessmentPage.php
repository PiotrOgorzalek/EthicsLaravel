...
<html>
	...
	<body class="is-preload">
				...
				<div class="inner">
						...
						<article class="box post post-excerpt">
							<header>
								<!--
									...
									need a subtitle.
								-->
								<h2>Initial Assessment Questions</h2>
								<p></p>
							</header>

							<p>
								Do I need to do ethics:
							</p>
			        ...
			        <div id="surveyResult"></div>
							<div id="footer">
								...
								<button type="submit" button id="saveButton" onclick="window.open('./certificates/noEthicsCertificate.pdf?download=1')">SAVE AS PDF</button>
							</div>
						</article>
		...
		<!-- Scripts -->
			<script type="text/javascript" src="./initialAssessment.js"></script>
